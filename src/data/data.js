...
const popularsales = {
  ...
  items: [
    ...
    },
    {
      ...
      img: psale1,
      price: "200",
      color: "from-slate-800 to-rose-400",
  ...
  items: [
    {
      ...
      img: product7,
      price: "150",
      color: "from-sky-600 to-indigo-300",
      shadow: "shadow-lg shadow-blue-500",
    },
    {
      id: "0M0x2",
    ...
    },
    {
      ...
      img: product9,
      price: "150",
      color: "from-[#936550] to-orange-600",
    ...
    },
    {
      ...
      img: product11,
      price: "150",
      color: "from-slate-900 to-slate-300",
...
const story = {
  ...
  news: [
    ...
    },
    {
      ...
      text: "The Bred coloryway of Zoom GT Cut 2 will be first to release this Friday, For Nike Members Nation World Wide while Sabrina Ionescus colorway is set for an October 13th release date. In the meantime, enjoy official images of both colorways below which will be available.",
